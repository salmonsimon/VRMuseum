...
/* Stored parameter configuration that can be applied to a IsdkPokeInteractable */
UCLASS(
    BlueprintType,
...
/**
 * IsdkPokeInteractable drives the ability for an actor to be poked, initiated by a single finger
 * non-physics interaction. It is expected to be interacted with by a IsdkPokeInteractor on the
 * player pawn.
 */
UCLASS(
    Blueprintable,
