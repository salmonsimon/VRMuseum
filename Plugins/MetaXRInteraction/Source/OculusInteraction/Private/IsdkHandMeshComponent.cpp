...
{
  if ((uint8)HandPoseLerpState > 0 && HandPoseLerpTime > 0.f)
  {
...
void UIsdkHandMeshComponent::SetMappedBoneNamesAsDefault(EIsdkHandType HandType)
{
...
void UIsdkHandMeshComponent::SetHandPoseOverride(UIsdkHandPoseData* PoseDataIn)
{
