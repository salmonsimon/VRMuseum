...
UIsdkHandRigComponentLeft::UIsdkHandRigComponentLeft(const FObjectInitializer& ObjectInitializer)
    : UIsdkHandRigComponent(
          ObjectInitializer.DoNotCreateDefaultSubobject(TEXT("ControllerVisuals")))
{
...
UIsdkHandRigComponentRight::UIsdkHandRigComponentRight(const FObjectInitializer& ObjectInitializer)
    : UIsdkHandRigComponent(
          ObjectInitializer.DoNotCreateDefaultSubobject(TEXT("ControllerVisuals")))
{
