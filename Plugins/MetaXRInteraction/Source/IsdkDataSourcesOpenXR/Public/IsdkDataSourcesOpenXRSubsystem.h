                                                                  ...
                                                                  public IIsdkITrackingDataSubsystem
{
 ...
 public:
   ...
   * @param AttachToMotionController The motion controller to which the hand data source will be
   * attached.
   ...
   * @param AttachToMotionController The motion controller to which the controller data source will
   * be attached.
 ...
 private:
  UPROPERTY()
  TObjectPtr<UIsdkFromOpenXRControllerDataSource> ControllerDataSource;

  UPROPERTY()
  TObjectPtr<UIsdkFromOpenXRHandDataSource> HandDataSource;

  UPROPERTY()
  TObjectPtr<UIsdkFromOpenXRHmdDataSource> HmdDataSource;
