      ...
      public IIsdkIRootPose
{
 ...
 public:
  ...
  /**
   * @brief Assigns a new motion controller component to this data source.
   * @param InMotionController The new motion controller component.
   *
   * Use this method if you need to change the motion controller associated with this data source.
   * The system will automatically adjust to the new controller.
   */
