...
class AIsdkTestRigActor : public AActor
{
 ...
 public:
  ...
  AIsdkTestRigActor()
  {
    ...
    constexpr auto LeftHandType = EIsdkHandType::HandLeft;
    HandVisuals->SetSubobjectPropertyDefaults(LeftHandType);
    ControllerVisuals->SetSubobjectPropertyDefaults(LeftHandType);
    InputActions->SetSubobjectPropertyDefaults(LeftHandType);
  ...
  virtual void BeginPlay() override
  {
    ...
    FakeTrackingDataSubsystem = GetWorld()->GetSubsystem<UIsdkFakeTrackingDataSubsystem>();
    if (FakeTrackingDataSubsystem)
    {
