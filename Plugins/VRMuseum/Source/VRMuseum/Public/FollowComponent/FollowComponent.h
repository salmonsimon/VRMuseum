 ...
 */
UCLASS( ClassGroup=(VRMuseum), meta=(BlueprintSpawnableComponent) )
class VRMUSEUM_API UFollowComponent : public UActorComponent
{
	GENERATED_BODY()
...
public:	
	...
	UFUNCTION(BlueprintCallable, Category = "FollowComponent")
	void Recenter();

	/** Actor that this component will follow. If null, this component will follow the camera */
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "FollowComponent")
	...
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "FollowComponent", meta = (EditCondition = "!bIgnoreDistanceClamp", EditConditionHides))
	...
	UPROPERTY(
		EditAnywhere, BlueprintReadWrite, Category = "FollowComponent", meta = (EditCondition = "bUseFixedVerticalOffset", EditConditionHides))
	...
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "FollowComponent", meta = (EditCondition = "!bIgnoreAngleClamp", EditConditionHides))
	...
	UPROPERTY(
		EditAnywhere, BlueprintReadWrite, Category = "FollowComponent",
